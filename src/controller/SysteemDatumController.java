...
public class SysteemDatumController implements Handler {
	...
	/**
	 * De SysteemDatumController klasse moet alle systeem (en test)-gerelateerde
	 * aanvragen afhandelen. Methode handle() kijkt welke URI is opgevraagd en laat
	 * dan de juiste methode het werk doen. Je kunt voor elke nieuwe URI een nieuwe
	 * methode schrijven.
	 * 
	...
	private void ophalenLesInfo(Conversation conversation) {
		...
		// Deze volgorde mag niet worden gewijzigd i.v.m. JS. (Hier mag dus ook geen
		// andere JSON voor komen.)
		lJsonObjectBuilder.add("eerste_lesdatum", PrIS.calToStandaardDatumString(lEersteLesDatum))
